...
1. **Database Initialization**: `initdb.js` populates SQLite with sample data
2. **Server Actions**: Handle form submissions and database operations
3. **API Routes**: Next.js handles routing and server-side rendering
4. **Client Components**: React components manage UI state and interactions
